...
export const FormItem = ({
  ...
  return (
    <section id="Booking-Details" className="px-4 mt-5 z-10">
      <div
        className={`accordion flex flex-col rounded-[20px] border border-[#EFF2F7] p-5 gap-[18px] bg-white overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        <div
          className={`mt-4 flex flex-col gap-4 transition-opacity duration-300 ease-in-out ${
